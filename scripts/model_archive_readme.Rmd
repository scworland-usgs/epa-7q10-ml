...
Note that the variable importance and partial dependence don't actually require direct inputs from the other functions above. However, the model selections for the variable importance are based off pieces of the earlier analysis. The very last step is to create plots from the paper (skip the monte-carlo for now):
...
\begin{figure}[ht]
\begin{center}
\includegraphics[width=4in]{~/Documents/Ungaged basins/epa_7q10_ml/figures/epa_7q10_algorithm.png}
\end{center}
\end{figure}
